...
from gdist.gschemas import build_gschemas, install_gschemas
...
class build(distutils_build):
    ...
    sub_commands = distutils_build.sub_commands + [
        ...
        ("build_gschemas",
         lambda self: self.distribution.has_gschemas()),
        ]
...
class install(distutils_install):
    ...
    sub_commands = distutils_install.sub_commands + [
        ...
        ("install_gschemas", lambda self: self.distribution.has_gschemas()),
       ]
...
class GDistribution(Distribution):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.cmdclass.setdefault("build_gschemas", build_gschemas)
        ...
        self.cmdclass.setdefault("install_gschemas", install_gschemas)
    ...
    def has_gschemas(self):
        return os.name != 'nt' and bool(self.gschemas)
